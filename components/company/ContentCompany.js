      ...
      <div className='container'>
        <div className='row justify-content-center'>
          <div className='col-md-6'>
            <p className='serif'>Quienes Somos</p>
            ...
            <h3>Misión</h3>
            <p>
              Desarrollar productos residenciales y negocios inmobiliarios
              vinculados al turismo, logrando rentabilidad para los inversores,
              nuestros clientes.
            </p>
            <p>
